document.addEventListener("DOMContentLoaded",function(){
    randomTask();
    document.getElementById('idea-but').addEventListener("click",randomTask)});
...
function randomTask() {
    var taskList = [
        ...
        {name:"doodle!", description: "Unleash your creativity", img: "images/doodle.png",link:"https://upliftingplay.com/"},
